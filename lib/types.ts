...
export type PlanTier = 'basic' | 'interdiario' | 'diario' | 'por_dia' | 'promo_exclusiva_diario' | 'cliente_antiguo_3meses' | 'promo_cliente_medium_3meses' | 'diario_trotadora' | 'interdiario_trotadora' | 'diario_escolar_universitario'
export type Weekday =
  | 'monday'
  | 'tuesday'
  | 'wednesday'
